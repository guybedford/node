...
2. If X matches this pattern and DIR/name/package.json is a file:
   ...
   b. If subpath is empty and "default" is null or undefined, GOTO 3.
   c. If subpath is not empty and "exports" is null or undefined, GOTO 3.
   d. If subpath is empty, let target = the value of "default"
   ...
   e. let RESOLVED_URL =
        ...
        subpath.slice(key.length), ["require", "node"]), as defined in the esm
        resolver.
