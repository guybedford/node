...
`ERR_WORKER_HANDLE_NOT_TRANSFERABLE`. Both TCP sockets and pipe-backed sockets
(Unix domain socket connections and named pipe connections) can be transferred.
An [IPC][] channel socket cannot be transferred.
