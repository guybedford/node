...
/**
 * @type {WeakMap<import('internal/modules/esm/utils').ModuleNamespaceObject, WebAssembly.Instance>} [[Instance]] slot proxy for WebAssembly Module Record
 */
...
translators.set('wasm', async function(url, source) {
  ...
  // Existence used for cycle checks
  const ns = module.getNamespace();
  wasmInstances.set(ns, null);
