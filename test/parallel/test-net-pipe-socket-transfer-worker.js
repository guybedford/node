...
// socket, or a named pipe on Windows) can be transferred to a worker thread
// via worker_threads postMessage()'s transferList. On Windows this exercises
// libuv's event-based completion fallback, since the transferred pipe cannot
// be re-associated with the receiving loop's IOCP.
